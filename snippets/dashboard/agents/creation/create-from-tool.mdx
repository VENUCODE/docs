...
<Step title="Select Create from Tool">
  ...
  <Frame>
  <img src="/images/dashboard/tool/step1.png" alt="Create Agent page showing Create from Tool card selection" />
  </Frame>
</Step>

<Step title="Select tool and configure agent">
  A modal opens where you can select the tool you wish to use and change the agent's icon.
  
  <Frame>
  <img src="/images/dashboard/tool/step-2-tool-selection.png" alt="Tool selection modal showing available tools and agent icon options" />
  </Frame>
...
<Step title="Authenticate with the tool">
  After selecting a tool, another modal opens for tool authentication with different authentication types.
  
  <Frame>
  <img src="/images/dashboard/tool/step-3-tool-authentication.png" alt="Tool authentication modal showing different authentication methods" />
  </Frame>
...
<Step title="Tool connected and ready">
  After successful authentication, you're redirected back to the page where the tool is connected.
  
  <Frame>
  <img src="/images/dashboard/tool/step-4-tool-connected-create-agent.png" alt="Tool connected modal showing successful connection and Create Agent button enabled" />
  </Frame>
...
<Step title="Agent created and ready">
  ...
  <Frame>
  <img src="/images/dashboard/tool/step-5-agent-created-in-canvas.png" alt="Completed agent creation showing tool-connected agent in canvas ready for interaction" />
  </Frame>
