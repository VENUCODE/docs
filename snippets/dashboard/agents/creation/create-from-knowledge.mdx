...
<Step title="Click Create from Knowledge card">
  ...
  <Frame>
  <img src="/images/kbs/create-from-kb-step-1.png" alt="Create Agent page showing the Create from Knowledge card option" />
  </Frame>
...
<Step title="Select data source and customize agent">
  ...
  <Frame>
  <img src="/images/kbs/create-from-kb-step-2.png" alt="Data source selection and agent customization options" />
  </Frame>
...
<Tip>
**Content Quality**: The effectiveness of your agent depends on the quality and organization of your source content. Ensure your website or documents are well-structured and comprehensive.
</Tip>

<Warning>
**Content Updates**: If your source website or documents change significantly, you may need to retrain your knowledge base to ensure the agent has access to the latest information.
</Warning>
