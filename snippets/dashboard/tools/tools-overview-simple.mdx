...
<Step title="Add the tool">
  - Click the **"Add Tool"** button on the tool's page - A modal will open with
  authentication input fields - The modal will show different authentication
  options based on the tool
</Step>
