## <Icon icon="wrench" size="30" /> Connect Tools

Now let's connect the Gmail tool to your agent to send email notifications.
<AccordionGroup>
<Accordion title="Navigate to Tools" defaultOpen="true">
...
<Accordion title="Follow the Detailed Guide">
...
<Accordion title="Verify Your Connections">
