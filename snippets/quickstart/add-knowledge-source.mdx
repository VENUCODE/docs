...
<Callout icon="book"  color="#FFC107">
  Check out our [step-by-step guide](/platform-fundamentals/platform-tour/knowledge-base) on creating a Knowledge Base covering all data source types, training, and testing.
</Callout>
