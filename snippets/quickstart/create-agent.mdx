...
### <Icon icon="plus" size="30" /> Create Agent from Scratch

1. Navigate to the **Create Agents** page in your Tars dashboard: [https://app.hellotars.com/agents?tab=create-agent](https://app.hellotars.com/agents?tab=create-agent)
...
### <Icon icon="paintbrush" size="30" /> Enter Builder Canvas

You'll be redirected to the Builder Canvas. This is where all the workflow of your agent is built.To get started, add the Agent Gambit from the gambits panel.

<Frame>
  <img src="/images/quickstart/gifs/add-agent-to-canvas.gif" alt="Adding agent gambit to builder canvas" />
</Frame>

### <Icon icon="play" size="30" /> Basic Agent Publish and Preview
...
### <Icon icon="arrows-rotate" size="30" /> Self-Loop the Agent
...
### <Icon icon="play" size="30" /> Publish and Preview
...
### <Icon icon="database" size="30" /> Add Knowledge Base
...
### <Icon icon="check" size="30" /> Select Knowledge Base
...
### <Icon icon="link" size="30" /> Connect Knowledge Base
...
### <Icon icon="flask" size="30" /> Test with Knowledge
...
### <Icon icon="envelope" size="30" /> Add Gmail Tool
...
### <Icon icon="check" size="30" /> Select Gmail Tool
...
### <Icon icon="link" size="30" /> Connect Gmail Tool
...
### <Icon icon="gear" size="30" /> Configure Agent Settings
...
### <Icon icon="wand-magic-sparkles" size="30" /> Customize Agent Prompt
...
### <Icon icon="flask" size="30" /> Final Testing
