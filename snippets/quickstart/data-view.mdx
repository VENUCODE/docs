...
### <Icon icon="chart-line" size="30" /> Navigate to Data View
...
### <Icon icon="messages" size="30" /> View conversation history
...
### <Icon icon="circle-info" size="30" /> Track conversation sources
...
### <Icon icon="calendar" size="30" /> Filter conversations by date
...
### <Icon icon="code" size="30" /> Debug with Gambit Execution Logs
