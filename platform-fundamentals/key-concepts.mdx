...
<CardGroup cols={2}>
  <Card title="Decision Framework" icon="compass" href="/platform-fundamentals/decision-framework">
...
<CardGroup cols={2}>
  <Card title="Implementation Strategy" icon="strategy" href="/introduction-to-development/getting-started-with-workflow">
  ...
  <Card title="Success Guidelines" icon="target" href="/platform-fundamentals/platform-tour">
...
<CardGroup cols={2}>
  <Card title="Development Lifecycle" icon="code" href="/introduction-to-development/development-lifecycle-overview">
    **Complete Development Process**<br/>
...
<Note>
**Questions about implementation?** Join our [Community Forum](/community-support/community-forum) to connect with other Tars users and get expert guidance from our team.
</Note>