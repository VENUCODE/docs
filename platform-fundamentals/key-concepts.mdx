...
**Conversational Automation and Agentic Workflows Made Simple and Reliable**
Tars replaces static forms with dynamic, step-by-step interactions that guide users progressively through personalized conversations, presenting information at the right moment rather than overwhelming them with everything at once. Through a no-code drag-and-drop builder, Tars empowers anyone to build personalized AI Agents, ensuring accuracy with AI evaluation and hybrid search to eliminate hallucinations, providing complete control over conversation flows with precise logic using Gambits, and offering flexible options that adapt to diverse business needs.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
  >
    Learn how to `Make`,`Test`,`Deploy`,`Analyze`,`Iterate` to build, optimize, and scale your AI Agents effectively.
  </Card>

  <Card title="Start Building" icon="rocket" href="/quickstart/your-first-agent" arrow="true">
...
<Note>
  **Questions about implementation?** Join our [Community
  Forum](/getting-help/community-forum) to connect with other Tars users
