...
<Columns cols={2}>
  <Card title="Semantic Understanding" icon="brain">
    **Deep Comprehension** - Understand meaning beyond keywords - Handle
    synonyms and related concepts - Recognize implicit requests and intentions -
    Process complex, multi-part questions
  </Card>
  <Card title="Contextual Awareness" icon="eye">
    **Conversation Context** - Remember previous conversation turns - Understand
    references to earlier topics - Maintain thread of conversation logic - Adapt
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="/ai-technology/prompt-engineering"
  >
  ...
  <Card
    ...
    icon="memory"
    href="/ai-technology/context-management"
  >
  ...
  <Card
    ...
    icon="cpu"
    href="/ai-technology/model-selection"
  >
  ...
  <Card
    ...
    icon="settings"
    href="/ai-agents/agent-configuration/response-optimization"
  >
...
<Note>
  **Technical Note**: While understanding LLMs is helpful, Tars abstracts much
  of the complexity. You can build effective agents without deep technical
  knowledge, but understanding the underlying technology helps you optimize
  performance.
</Note>
