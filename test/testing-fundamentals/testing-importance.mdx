...
<Columns cols={2}>
  <Card title="Customer Impact" icon="users">
    **Negative Experiences:** - 67% of users abandon poorly performing chatbots
    - Bad first impressions are hard to overcome - Customer support tickets
    increase - Brand reputation damage
  </Card>
  <Card title="Business Impact" icon="trending-down">
    **Operational Costs:** - Emergency fixes cost 5x more than prevention - Lost
    sales and conversion opportunities - Increased support team workload -
...
<CardGroup cols={2}>
  <Card
    ...
    icon="clipboard-list"
    href="/test/testing-fundamentals/testing-methodologies"
  >
  ...
  <Card
    ...
    icon="eye"
    href="/test/preview-testing/real-time-preview"
  >
  ...
  <Card
    ...
    icon="star"
    href="/test/testing-fundamentals/testing-best-practices"
  >
  ...
  <Card
    ...
    icon="speedometer"
    href="/test/performance-testing/response-time-testing"
  >
...
<Note>
  **Testing Mindset**: Think of testing as an investment, not a cost. Thorough
  testing pays dividends in user satisfaction, reduced support costs, and faster
